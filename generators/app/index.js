...
var CastleFactoryGenerator = yeoman.generators.Base.extend({
  ...
  writing: function() {
    ...
    copyTemplate('_test/_factory.spec.js', 'client/test/unit/common/directives/' + answers.paramCaseDirectiveName + '.spec.js');
    addToIndex('tmp/common/factories/' + answers.paramCaseDirectiveName + '.js');
    addToAppModules('common.factories.' + answers.pascalCaseFactoryName);
  },
});
